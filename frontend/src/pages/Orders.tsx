                ...
                <div className="px-3 md:px-4 py-3 bg-gray-50 border-t border-gray-200 animate-fade-in">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-4">
                    <div className="bg-white p-2 rounded-lg">
                      ...
                      <p className="text-sm text-gray-900 font-semibold">{order.customerName}</p>
                    </div>
                    <div className="bg-white p-2 rounded-lg">
                      <p className="text-xs text-gray-500 font-medium mb-1">Phone</p>
                      <p className="text-sm text-gray-900 font-semibold">{order.customerPhone}</p>
                    </div>
                  </div>

                  {/* Products List */}
                  {order.shopifyOrderData && typeof order.shopifyOrderData === 'object' && (order.shopifyOrderData as any).line_items && (
                    <div className="mb-4">
                      <h5 className="font-bold text-gray-900 mb-2 text-xs md:text-sm">Products Ordered:</h5>
                      <div className="space-y-2">
                        {((order.shopifyOrderData as any).line_items || []).map((item: any, idx: number) => (
                          <div key={idx} className="bg-white p-3 rounded-lg border border-gray-200">
                            <div className="flex justify-between items-start mb-2">
                              ...
                              <span className="ml-2 px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-bold flex-shrink-0">
                                x{item.quantity || 1}
                              </span>
                            </div>
                      ...
                      {/* Order Total */}
                      <div className="mt-3 p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border-2 border-green-200">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    ...
                    <div className="bg-white p-2 rounded-lg">
                      <p className="text-gray-500 font-medium mb-1">Status Updated</p>
                      <p className="text-gray-900 font-semibold">
                        {order.status === 'pending' ? 'Waiting' : 'Auto-updated'}
                      </p>
                    </div>
                  </div>
                </div>
