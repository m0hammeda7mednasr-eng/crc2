...
const Settings = () => {
  ...
  return (
    <div className={`max-w-4xl mx-auto space-y-4 md:space-y-6 ${isMobile ? 'px-0' : ''}`}>
      <div className={`flex flex-col md:flex-row md:justify-between md:items-start gap-3 md:gap-0 ${isMobile ? 'px-4' : ''}`}>
        <div>
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-1 md:mb-2">Settings</h1>
          <p className="text-sm md:text-base text-gray-600">Configure your integrations and preferences</p>
        </div>
      ...
      {message && (
        <div className={`p-3 md:p-4 rounded-xl border-2 animate-fade-in ${isMobile ? 'mx-4' : ''} ${
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            {message.includes('success') || message.includes('successful') ? (
              <svg className="w-5 md:w-6 h-5 md:h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
        <div className={`bg-white ${isMobile ? 'rounded-none border-y' : 'rounded-2xl border'} shadow-lg p-6 md:p-8 border-gray-200`}>
          <div className="flex items-center space-x-3 md:space-x-4 mb-4 md:mb-6">
            <div className="w-12 md:w-14 h-12 md:h-14 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0">
              <svg className="w-6 md:w-8 h-6 md:h-8 text-green-600" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-gray-900">WhatsApp Integration</h2>
              <p className="text-xs md:text-base text-gray-600">Configure your n8n webhook for WhatsApp messages</p>
            </div>
          </div>
      ...
      <div className={`bg-white ${isMobile ? 'rounded-none border-y' : 'rounded-2xl border'} shadow-lg p-6 md:p-8 border-gray-200`}>
        <div className="flex items-center space-x-3 md:space-x-4 mb-4 md:mb-6">
          <div className="w-12 md:w-14 h-12 md:h-14 bg-purple-100 rounded-xl flex items-center justify-center flex-shrink-0">
            <svg className="w-6 md:w-8 h-6 md:h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
            </svg>
          </div>
          <div>
            <h2 className="text-xl md:text-2xl font-bold text-gray-900">Shopify Integration</h2>
            <p className="text-xs md:text-base text-gray-600">Connect your Shopify store and configure webhooks</p>
          </div>
        </div>
